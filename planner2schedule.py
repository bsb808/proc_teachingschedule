...
fname = 'MAE_MasterCoursePlan_AY26.xlsx'
...
# This defines the start and end of the row range to consider.
# For AY25
# The row for the fall quarter of the AY
fall_row = 13
# The row for the summer quarter of the AY
summer_row = 16
...
ts.cell(row = 1, column = 1,
        value = 'Draft Teaching Schedule Autogenerated on ' + now.strftime('%d %b %Y %H:%M:%S')  + " DO NOT EDIT MANUALLY!" )
